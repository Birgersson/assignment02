...
public class AdvancedCalculatorTest {
	...
	public void testMax() {
			...
			for (int i = 0; i<10; i++) {
				tempN1 = random.nextDouble()*100;
				tempN2 = random.nextDouble()*100;
			...
			for (int i = 0; i<10; i++) {
				tempN1 = random.nextDouble()*100*(-1);
				tempN2 = random.nextDouble()*100;
				LOG.info("Testing max(-) with: " +tempN1 +" and " +tempN2 );
